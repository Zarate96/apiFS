    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cp', models.CharField(max_length=100, validators=[shared.validators.cp_validator], verbose_name='Código postal')),
                ...
                ('telefono', models.CharField(max_length=30, validators=[shared.validators.phone_validator], verbose_name='Numero teléfonico')),
                ('rfc', models.CharField(max_length=13, validators=[shared.validators.rfc_validator], verbose_name='RFC')),
                ('es_empresa', models.BooleanField(default=False, help_text='Las empresas son personas morales', verbose_name='Persona moral')),
                ('es_verificado', models.BooleanField(default=False)),
                ('direccion_google', models.CharField(blank=True, max_length=200, verbose_name='Direccón regresada por Google Api')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefono', models.CharField(max_length=50, validators=[shared.validators.phone_validator], verbose_name='Numero teléfonico')),
